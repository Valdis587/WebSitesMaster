...
function breadcrumbs() {
    ...
    $wrap_before = '<ul class="topPanel__breacrumbs">'; // открывающий тег обертки
    $wrap_after = '</ul><!-- .breadcrumbs -->'; // закрывающий тег обертки
    $sep = '<i class="icon-angle-down"></i>'; // разделитель между "крошками"
    $sep_before = ''; // тег перед разделителем
    $sep_after = ''; // тег после разделителя
    $show_home_link = 1; // 1 - показывать ссылку "Главная", 0 - не показывать
    $show_on_home = 0; // 1 - показывать "хлебные крошки" на главной странице, 0 - не показывать
    $show_current = 1; // 1 - показывать название текущей страницы, 0 - не показывать
    $before = '<li class="topPanel__breacrumbs-active"><a>'; // тег перед текущей "крошкой"
    ...
    if (is_home() && !is_front_page())  {
        ...
        echo $sep;
        echo '<li class="topPanel__breacrumbs-active"><a>';
        echo wp_title('');
        echo '</a></li>';
    }
    /////
