...
function WebMaster_menu_page() {
    wp_nav_menu([
        'theme_location'  => 'menu-page',
        'menu'            => 'page',
        'container'       => false,
        'menu_class'      => 'footer__list',
        'walker'          => new WebMaster_Walker_Nav_menu_page()
    ]);
}
...
register_nav_menus(
    array(
        'menu-service' => esc_html__( 'Меню футера "Сервис"', 'autoparts' ),
    )
);

function WebMaster_menu_service() {
    wp_nav_menu([
...
class WebMaster_Walker_Nav_menu_page extends Walker_Nav_Menu {
