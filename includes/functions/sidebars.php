 ...
 */
function webmaster_widgets_init() {
    register_sidebar(
        array(
            'name'          => esc_html__( 'Сайдбар новостей', 'webmaster' ),
            'id'            => 'sidebar-news',
            'description'   => esc_html__( 'Add widgets here.', 'webmaster' ),
...
add_action( 'widgets_init', 'webmaster_widgets_init' );